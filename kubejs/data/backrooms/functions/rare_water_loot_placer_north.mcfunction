...
execute if score RNG RNG_Variable matches 1 run setblock ~ ~ ~ refurbished_furniture:light_electricity_generator[facing=south]
execute if score RNG RNG_Variable matches 2 run setblock ~ ~ ~ moyai:moyai[facing=north]
