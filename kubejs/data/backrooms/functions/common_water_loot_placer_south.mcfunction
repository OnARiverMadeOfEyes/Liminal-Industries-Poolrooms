...
execute if score RNG RNG_Variable matches 2 run setblock ~ ~ ~ mekanism:radioactive_waste_barrel[facing=south,fluid_logged=water]
...
execute if score RNG RNG_Variable matches 5..8 run function backrooms:rare_water_loot_placer_south